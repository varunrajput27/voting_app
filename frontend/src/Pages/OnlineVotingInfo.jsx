    ...
    icon: (
      ...
      >
        <path
          ...
          strokeWidth={2}
          d="M5.121 17.804A13.937 13.937 0 0112 15c2.833 0 5.422.863 7.579 2.336M15 11a3 3 0 11-6 0 3 3 0 016 0z"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M12 11c0-1.38 1.12-2.5 2.5-2.5S17 9.62 17 11m-5 0v5m0-5H7m5 0h5"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M12 11c0-1.38-1.12-2.5-2.5-2.5S7 9.62 7 11m5 0v5m0-5h5m-5 0H7"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M3 10h11M3 6h11M3 14h7m4 4h2a2 2 0 002-2v-4a2 2 0 00-2-2h-2m-4 6h2a2 2 0 002-2v-4a2 2 0 00-2-2h-2"
        />
      </svg>
    ),
  },
...
const OnlineVotingInfo = () => {
  ...
  const handleRegisterClick = () => {
    if (exiting) return; // prevent multi clicks
    setExiting(true);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-indigo-50 font-sans">
      ...
      >
        {/* Header */}
        <section className="text-center mt-8 max-w-4xl mx-auto mb-16 p-8 md:p-16">
          <h1 className="text-5xl font-extrabold text-indigo-900 mb-4 drop-shadow-lg">
            How Online Voting Works
          </h1>
          <p className="text-indigo-700 text-lg md:text-xl italic tracking-wide">
        ...
        {/* Steps */}
        <section id="steps" className="max-w-5xl mx-auto mb-20 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {steps.map(({ title, desc, icon }, idx) => (
              <div
                key={idx}
                className="flex gap-6 items-start bg-white rounded-xl shadow-lg p-8 border border-indigo-200 hover:shadow-indigo-400 transition transform hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-indigo-300"
        ...
        <section
          id="turnout"
          className="max-w-4xl mx-auto mb-20 bg-white p-10 rounded-xl shadow-lg border border-indigo-300"
        >
          <h2 className="text-4xl font-bold text-indigo-900 mb-8 text-center">
            Voter Turnout Over The Years
          </h2>
          <div className="flex items-end gap-6 justify-center h-56">
            {turnoutData.map(({ year, turnout }) => (
              <div key={year} className="flex flex-col items-center">
                <div
                  className="bg-indigo-600 rounded-t-lg transition-all duration-700 ease-in-out"
                  style={{ height: `${turnout * 2}px`, width: "36px" }}
                  title={`${turnout}% turnout`}
                />
                <span className="mt-3 text-indigo-800 font-semibold">{year}</span>
              </div>
            ))}
          </div>
          <p className="mt-6 text-center text-indigo-700 italic">
        ...
        <section
          id="security"
          className="max-w-6xl mx-auto mb-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-6"
        >
          <img
            src={securevoting}
          ...
          />
          <div>
            <h2 className="text-4xl font-bold text-indigo-900 mb-6">Voting is Safe and Confidential</h2>
            <p className="text-indigo-700 text-lg mb-4 leading-relaxed">
        ...
        {/* Call To Action with spacing before footer */}
        <section className="text-center max-w-3xl mx-auto py-16 bg-indigo-700 rounded-3xl shadow-xl text-white mb-32">
          {/* mb-32 adds space below this section, preventing touching footer */}
          <h2 className="text-4xl font-extrabold mb-6">Ready to Vote Online? Join The Movement Today!</h2>
          ...
          <motion.button
            ...
            disabled={exiting}
            className={`bg-yellow-400 hover:bg-yellow-300 text-indigo-900 font-bold py-4 px-10 rounded-full text-xl shadow-lg transition cursor-pointer focus:outline-none focus:ring-4 focus:ring-yellow-300 ${
